...
def campus(request):
    ...
    active_companies=["Vision Mastermind","Nurturing Lives","Synergy","LAUNCHiT","&Evolve","Learnation","Pasken","Studbud","Passed On Wisdom","Dot Lit Media"]
